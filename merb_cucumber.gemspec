...
Gem::Specification.new do |s|
  ...
  s.authors = ["Roman Gonzalez", "David Leal", "Justin Smestad"]
  s.date = %q{2009-01-09}
  s.description = %q{Cucumber / Webrat integration for Merb}
  s.email = ["romanandreg@gmail.com", "dgleal@gmail.com", "justin.smestad@gmail.com"]
  ...
  s.has_rdoc = true
  s.homepage = %q{http://github.com/jsmestad/merb_cucumber}
  s.require_paths = ["lib"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<webrat>, [">=0.4.0"])
    else
      s.add_dependency(%q<merb-core>, ["~> 1.0"])
      s.add_dependency(%q<cucumber>, [">= 0.1.14"])
      s.add_dependency(%q<webrat>, [">= 0.4.0"])
    end
  else
    s.add_dependency(%q<merb-core>, ["~> 1.0"])
    s.add_dependency(%q<cucumber>, [">= 0.1.14"])
